...
FrMimeTypeDescription mime_type_desc[] = {
	...
	{ "application/x-iso9660-appimage",     ".AppImage", 0 },
...
FrExtensionType file_ext_type[] = {
	...
	{ ".sb", "application/vnd.squashfs" },
	{ ".sfs", "application/vnd.squashfs" },
	{ ".sxz", "application/vnd.squashfs" },
	{ ".sqfm", "application/vnd.squashfs" },
	...
	{ ".vdi", "application/x-disk-image" },
	{ ".vhd", "application/x-disk-image" },
	{ ".vhdx", "application/x-disk-image" },
	{ ".vmdk", "application/x-disk-image" },
	{ ".war", "application/x-war" },
	{ ".wim", "application/x-ms-wim" },
	{ ".xar", "application/x-xar" },
	{ ".xpi", "application/x-xpinstall" },
	{ ".xz", "application/x-xz" },
	{ ".xzm", "application/vnd.squashfs" },
